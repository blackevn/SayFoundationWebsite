  ...
  return (
    <div className="">
      <img
        ...
        src={'/FamilyColor.jpg'}
      />
      <div className='p-4 text-gray-600 text- lg:w-full'>
      <div className="">
      <p className="mb-4 lg:max-w-[50%] lg:text-xl font-semibold">
      ...
      <p className="lg:max-w-[50%] mb-4 lg:text-xl font-semibold">
