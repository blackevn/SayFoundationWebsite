...
const Landing = () => {
  ...
  return (
    <div className='flex flex-col lg:flex-row pt-20 lg:pt-36 px-4 gap-4'>
        ...
        className='h-full w-full lg:w-[50%] rounded-xl flex flex-col lg:flex-row justify-between relative overflow-hidden min-h-[300px]'>
        ...
        className={`p-4 w-full lg:w-[25%] rounded-xl flex flex-col justify-between bg-[url('/BeninChildren.jpg')] bg-no-repeat bg-cover relative overflow-hidden min-h-[300px]`}>
        ...
        className='w-full lg:w-[25%] rounded-xl p-4 flex flex-col justify-between relative bg-gradient-to-r from-green-500 min-h-[300px]'>
